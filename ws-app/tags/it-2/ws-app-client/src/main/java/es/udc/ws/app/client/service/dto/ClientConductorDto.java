...
public class ClientConductorDto {
	...
	public ClientConductorDto(Long idConductor, String nombre, String ciudad, String modeloCoche, byte horaInicio,
	...
	public ClientConductorDto(String nombre, String ciudad, String modeloCoche, byte horaInicio,
			byte horaFin, int puntuacionAcumulada, int totalViajes) {
		super();
		this.nombre = nombre;
		this.ciudad = ciudad;
	...
	public ClientConductorDto(Long idConductor, String ciudad, String modeloCoche, byte horaInicio, byte horaFin) {
		super();
		this.idConductor = idConductor;
		this.ciudad = ciudad;
		this.modeloCoche = modeloCoche;
