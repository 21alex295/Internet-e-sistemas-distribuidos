...
public class ConductorServiceTest {
	...
	@Test
	public void testAnadirConductoryBuscarConductor() throws InputValidationException,InstanceNotFoundException,ConductorNoEncontradoException{
	...
	@Test(expected = ConductorNoEncontradoException.class)
	public void testBuscarConductorNoExistente() throws InstanceNotFoundException,ConductorNoEncontradoException{
		conductorService.buscarConductor(NON_EXISTENT_CONDUCTOR_ID);
	}
	
	@Test
	public void testActualizar() throws InputValidationException, InstanceNotFoundException,ConductorNoEncontradoException{
		...
		System.out.println(conductorAnadido.getIdConductor());
		conductorService.actualizarConductor(conductorAnadido);
		Conductor conductorEncontrado = conductorService.buscarConductor(conductorAnadido.getIdConductor());
		System.out.println(conductorEncontrado.getIdConductor());

		try{
			assertEquals(conductorAnadido.getCiudad(), conductorEncontrado.getCiudad() );
		}finally{
			conductorService.borrarConductor(conductorAnadido.getIdConductor());
		}
	...
	public void testActualizarConductorInvalido() throws InputValidationException,InstanceNotFoundException,ConductorNoEncontradoException{
	...
	@Test(expected = ConductorNoEncontradoException.class)
	public void testBorrarConductor() throws InstanceNotFoundException,ConductorNoEncontradoException{
	...
	public byte getHoraAntesValida(){
		...
		return horaAntesValida;
	}
	
	public byte getHoraDespuesValida(){
		Calendar fecha = Calendar.getInstance();
		byte hora = (byte) (fecha.get(Calendar.HOUR_OF_DAY));
	...
	public void testBuscarPorCiudad() throws InputValidationException, InstanceNotFoundException {
		...
		Conductor conductor1 = getValidConductor("Kike92","coru",getHoraAntesValida(),getHoraDespuesValida());
		Conductor conductor2 = getValidConductor("Pepe", "coru",getHoraAntesValida(),getHoraDespuesValida());
	...
	@Test
	public void testContratarBuscarViaje()throws InstanceNotFoundException,InputValidationException, ConductorNoEncontradoException{
		Conductor conductor = crearConductor(getValidConductor("Lazaro", "coru", getHoraAntesValida(),getHoraDespuesValida()));
		Viaje viaje = null;
		try{
	...
	@Test(expected = InputValidationException.class)
	public void testContratarViajeTarjetaInvalida()throws InputValidationException,InstanceNotFoundException,ConductorNoEncontradoException{
	...
	@Test(expected = ConductorNoEncontradoException.class)
	public void testContratarViajeConductorNoExistente()throws InputValidationException, InstanceNotFoundException,ConductorNoEncontradoException{
	...
	@Test
	public void testPuntuarViaje() throws InputValidationException, InstanceNotFoundException, PuntuacionRepetidaException,ConductorNoEncontradoException{
		Conductor conductor = conductorService.anadirConductor(getValidConductor("juanete", "coru", getHoraAntesValida(),getHoraDespuesValida()));
	...
	@Test
	public void testConductorInactivo() throws InputValidationException, InstanceNotFoundException, PuntuacionRepetidaException, ConductorNoEncontradoException{
		Conductor conductor = conductorService.anadirConductor(getValidConductor("juanete", "coru", getHoraAntesValida(),getHoraDespuesValida()));
	...
	@Test
	public void testViajesConductor() throws InputValidationException, InstanceNotFoundException, ConductorNoEncontradoException{
		
		Conductor conductor = conductorService.anadirConductor(getValidConductor("juanete", "coru", (byte)0,(byte)23));
	...
	@Test
	public void testViajesUsuario() throws InputValidationException, InstanceNotFoundException,ConductorNoEncontradoException{
		Conductor conductor1 = conductorService.anadirConductor(getValidConductor("paquito", "coru", getHoraAntesValida(),getHoraDespuesValida()));
		Conductor conductor2 = conductorService.anadirConductor(getValidConductor("chocolatero", "coru", getHoraAntesValida(),getHoraDespuesValida()));
